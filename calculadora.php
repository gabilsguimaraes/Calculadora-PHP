...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Rationale&family=VT323&display=swap" rel="stylesheet">
...
<body>
    <div class="calculadora">
        ...
        <form action="calculadora.php" method="POST">
            ...
            <button type="submit" name="calcular" style=" background-color:lightgreen; font-family: Rationale, sans-serif;font-size:20px;">CALCULAR</button>
            ...
            <div>
                <button type="submit" name="salvar" style=" background-color:lightsteelblue; font-family: Rationale, sans-serif; font-size:20px;">SALVAR</button>
                <button type="submit" name="pegarValores" style=" background-color:lightsteelblue; font-family: Rationale, sans-serif; font-size:20px;">PEGAR VALORES</button>
                <button type="submit" name="memoria" style=" background-color:khaki; font-family: Rationale, sans-serif; font-size:20px;">M</button>
                <button type="submit" name="apagarHistorico" style=" background-color:tomato; font-family: Rationale, sans-serif; font-size:20px;">APAGAR HISTORICO</button>
            </div>
